...
! function (e, t) {
    ...
    function ScrollSmoother(t) {
        ...
        O.forEach(function (e) {
            ...
            onRefresh: function onRefresh(e) {
                e.animation.invalidate(), B.y = 0, e.setPositions(e.start, refreshHeight() / A), h || Fa(e), B.y = -k() * A, Ga(B.y), M || (h && (g = !1), e.animation.progress(I.utils.clamp(0, 1, u / A / -e.end))), h && (e.progress -= .001, e.update()), ScrollSmoother.isRefreshing = !1
            },
            id: "ScrollSmoother",
            scroller: U,
    ...
    r.version = "3.14.1", r.create = function (e) {
